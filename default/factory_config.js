var FactoryConfig = { 
	'E33N36': {
		...
		produceList: [RESOURCE_EXTRACT, RESOURCE_CRYSTAL, RESOURCE_LEMERGIUM_BAR, RESOURCE_KEANIUM_BAR],
	},
	'E35N38': {
		need: {
			[RESOURCE_ENERGY]: 10000,
		...
		produceList: [RESOURCE_CONDENSATE, RESOURCE_PURIFIER, RESOURCE_KEANIUM_BAR, RESOURCE_REDUCTANT, RESOURCE_ZYNTHIUM_BAR],
	},
	'E29N34': {
		need: {
			[RESOURCE_ENERGY]: 10000,
